<?php /* Smarty version 3.1.24, created on 2015-07-19 18:02:45
         compiled from "C:/wamp/www/application/views/login.html" */ ?>
<?php
/*%%SmartyHeaderCode:892055ab75c55cbf09_21096803%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '75da8ae3684235cf5c804136cb02ed4fff23a4e7' => 
    array (
      0 => 'C:/wamp/www/application/views/login.html',
      1 => 1437297655,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '892055ab75c55cbf09_21096803',
  'has_nocache_code' => false,
  'version' => '3.1.24',
  'unifunc' => 'content_55ab75c5659739_10866449',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_55ab75c5659739_10866449')) {
function content_55ab75c5659739_10866449 ($_smarty_tpl) {

$_smarty_tpl->properties['nocache_hash'] = '892055ab75c55cbf09_21096803';
?>
...
<body>
        ...
        <div class="nav"> <!--导航区nav开始-->
            ...
            <div class="nav_right"> <!--nav_right开始-->
            	<div class="nav_right_up">
                	<ul>
                    	<li class="one1"><a href="login.html">登录</a></li>
    ...
    <div class="login"> <!--login开始--> 
    	<div class="login_left">
       		<a href="discount"><img src="images/login_adv.jpg"/></a>  
                  	
        </div>
        
        <div class="login_right"> <!--右边登录注册区-->
        	<div class="login_right_up"><!--右边登录注册-->
            	<div class="text1">用户登录</div>
                <div class="text2">没有账号？</div>
                <div class="text3"><a href="caixiaodou?page=register.html">【立即注册】</a></div>
            </div>
        </div><!--右边登录注册区结束-->
        <form class="login_right_down" action="login/checkLogin" method="post"><!--注册表单-->
  			<div class="seg"> <!--表单开始-->
            <p><span class="star">*</span>
            <span class="pn">手机号码:</p></span><input class="frame" type="text" name="UserTel" />
            <br />
            <br />
            <br />
  			<p><span class="star">*</span>
            <span class="pn">登录密码:</p></span><input class="frame" type="password" name="UserPassword" />
			<br />
            <br />
            <br />
            <p><a href="#" class="repassword">找回密码</a></p>
            <input class="submit" type="submit" value="立即登录" style="cursor:pointer"/>
            </div><!--表单结束-->
